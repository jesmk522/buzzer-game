...
export const SCENES = {
  ...
  who_is_xiaobao: {
    ...
    sceneKey: 'diary',
    beats: [
      { type: 'narrate',  text: '你回頭問陳秀蘭：「你阿公有叫小寶的孫子嗎？」',                                                                 ms: 4000 },
      { type: 'dialogue', speaker: '陳秀蘭', text: '「我是獨生女……阿公從前有個乾孫叫小寶，但那家人 20 年前搬去加拿大了，完全沒聯絡。」',          ms: 7000 },
      { type: 'narrate',  text: '她倒抽一口冷氣。你的直覺閃過一個字：詐騙。',                                                                   ms: 4000 },
    ],
    next: 'pawn',
  },
  ...
  pawn: {
    ...
    beats: [
      ...
      { type: 'dialogue', speaker: '王老闆', text: '「我說要不要先跟家裡人講，他一直搖頭——不能讓秀蘭知道，她會罵。」',                                   ms: 6000 },
    ],
    choice: {
      prompt: '你還想多問什麼？',
      options: [
  ...
  pawn_exit: {
    ...
    sceneKey: 'pawn',
    beats: [
      { type: 'dialogue', speaker: '王老闆', text: '「他往郵局那邊走去，手上拿著現金袋。」',   ms: 4500 },
      { type: 'narrate',  text: '你心裡有個底了。郵局旁邊，就是土地銀行。',                   ms: 3500 },
    ],
    next: 'bank',
  },
  ...
  bank_followup: {
    ...
    beats: [
      ...
      { type: 'dialogue', speaker: '林小姐', text: '「165 建議他就近到派出所做筆錄、凍結帳戶。但他說秀蘭會擔心，沒去。」',            ms: 6000 },
